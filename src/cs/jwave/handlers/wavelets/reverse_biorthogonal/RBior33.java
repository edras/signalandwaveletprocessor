...
import cs.jwave.handlers.wavelets.biorthogonal.Bior33;

/**
 * Ingrid Daubechies' orthonormal Biorthogonal wavelet of eight coefficients and the
 * scales; normed, due to ||*||2 - euclidean norm.
 * 
 * @date 10.02.2010 16:32:38
 * @author Christian Scheiblich
 */
public class RBior33 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Bior33 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
