...
import cs.jwave.handlers.wavelets.biorthogonal.Bior26;

/**
 * Ingrid Daubechies' orthonormal Biorthogonal wavelet of fourteen coefficients and the
 * scales; normed, due to ||*||2 - euclidean norm.
 * 
 * @date 10.02.2010 16:32:38
 * @author Christian Scheiblich
 */
public class RBior26 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Bior26 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
