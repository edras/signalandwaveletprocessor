...
import cs.jwave.handlers.wavelets.biorthogonal.Bior31;

/**
 * Ingrid Daubechies' orthonormal Biorthogonal wavelet of four coefficients and the
 * scales; normed, due to ||*||2 - euclidean norm.
 * 
 * @date 10.02.2010 16:32:38
 * @author Christian Scheiblich
 */
public class RBior31 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Bior31 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
