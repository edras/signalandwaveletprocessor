...
import cs.jwave.handlers.wavelets.biorthogonal.Bior15;
 ...
 * @author Christian Scheiblich
 */
public class RBior15 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Bior15 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
