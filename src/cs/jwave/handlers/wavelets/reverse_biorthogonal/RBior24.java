...
import cs.jwave.handlers.wavelets.biorthogonal.Bior24;
 ...
 * @author Christian Scheiblich
 */
public class RBior24 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Bior24 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
