...
/**
 * Ingrid Daubechies' orthonormal Symlet wavelet of twelve coefficients and the
 * scales; normed, due to ||*||2 - euclidean norm.
 * 
 * @date 10.02.2010 16:32:38
 * @author Christian Scheiblich
 */
public class Sym06 extends Wavelet {

  /**
   * Constructor setting up the orthonormal Symlet06 wavelet coeffs and the
   * scales; normed, due to ||*||2 - euclidean norm.
   * 
   * @date 10.02.2010 16:32:38
   * @author Christian Scheiblich
