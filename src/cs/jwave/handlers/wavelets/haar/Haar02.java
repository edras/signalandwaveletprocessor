 ...
 */
package cs.jwave.handlers.wavelets.haar;
...
public class Haar02 extends Wavelet {
  ...
  public Haar02( ) {
    ...
    _scales[ 0 ] = 1. / 1.4142135623730951; // w0 - normed by sqrt( 2 )
    _scales[ 1 ] = 1. / 1.4142135623730951; // w1 - normed by sqrt( 2 )

    _coeffs = new double[ _waveLength ];

    _coeffs[ 0 ] = -_scales[ 1 ]; //  w0
    _coeffs[ 1 ] = _scales[ 0 ]; // -w1
